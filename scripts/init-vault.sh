...
loadSecretsToVault() {
  ...
  vault kv put secrets/vpn-manager/vpnConfig vpnConfigfile="$(cat ./.openvpn-config)"
...
#   kvault "kube-system/oauth2-proxy/oauth2-proxy-helm-values.txt"
   ...
   kvault "clusters/my-cluster/monitoring/botkube/botkube-helm-values.txt"
...
#   kvault "default/valheim/valheim-helm-values.txt"
   kvault "clusters/my-cluster/velero/velero-helm-values.txt"
}
